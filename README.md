...
The bundled example dataset (`inst/extdata/`) is a small **simulated**
PBMC-style object generated by `dev/make_example_data.R`, with planted
low-quality and doublet populations so the QC controls have clear structure to
act on. The cookbook uses the real 10x pbmc3k dataset.
